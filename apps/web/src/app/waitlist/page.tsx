...
export default function Page() {
  return (
    <section className="relative h-screen w-screen flex justify-center bg-neutral-950">
      <div className="h-full w-full rounded-md bg-neutral-950 relative flex flex-col items-center antialiased">
        <div className="max-w-2xl mt-[10rem] mx-auto p-4 flex flex-col gap-y-4">
